...
# from the free World Bank API and writes a clean,
# flat json file that the rest of this project reads from
...
def fetch_real_country_names() -> Dict[str, str]:
    ...
    # income") into the same /country endpoint as actual countries. 
    names = {}
    page = 1
    while True:
